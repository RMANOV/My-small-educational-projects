...
#     new_key = i + 1
#     new_key = str(new_key) + 'f'
#     sales[new_key] = round((sales[i - 2] + sales[i - 1] + sales[i]) / 3)
...
#     # correct old forecast for 12 months against actual sales
#     for i in range(sales.__len__(), sales.__len__() - 12, 1):
#         new_key = i - 12
#         new_key = str(new_key) + 'f'
#         sales[new_key] = round((sales[i - 3] + sales[i - 2] + sales[i - 1]) / 3 )
#     # and calculate forecast for next 1 month
#     sales[sales.__len__() + 1] = round((sales[sales.__len__() - 2] + sales[sales.__len__() - 1] + sales[sales.__len__()]) / 3)
#     # keys should following the order of months in sales{} dictionary - for example sales = {1: 100, 2: 200, 3: 300, 4: 400, 5: 500, 6: 600, 7f: 700, 8f: 800, 9f: 900, 10f: 1000, 11f: 1100, 12f: 1200, 1f: 1300}
